      ...
      <CardContent>
        <Grid container justifyContent="space-between">
          <Grid item xs={9}>
            <Typography
              ...
              variant="h6"
              component="div"
              sx={{ m: "5px", fontWeight: "200", fontFamily: "Poppins" }}
            >
              {props.title}
            </Typography>
          </Grid>
          <Grid item xs={2}>
            <Fab color="primary" sx={{ bgcolor: "#2E2B36" }} size="medium">
              <PlayArrowIcon
                sx={{ fontSize: "1.5rem", color: "white", opacity: 0.5 }}
              />
            </Fab>
          </Grid>
        </Grid>
        ...
        >
          ...
          <Stack direction="column" alignItems="flex-end">
            ...
            >
              {nFormatter(parseInt(props.members), 1)}
            </Box>
          </Stack>
        </Stack>
